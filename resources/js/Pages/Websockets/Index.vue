...
export default {
    ...
    methods: {
        ...
        loadChart() {
            axios.get(`${this.api_endpoint}/${this.app.id}/statistics`)
                .then(({data}) => {
                    ...
                    Object.assign(this.series, chartData);
        ...
        subscribeToStatistics() {
            this.pusher.subscribe(`${this.log_channel_prefix}statistics`)
                .bind('statistics-updated', (data) => {
                    ...
                    this.series[0].data[0].x.push(data.time);
                    this.series[1].data[0].x.push(data.time);
                    this.series[2].data[0].x.push(data.time);
                    
                    this.series[0].data[0].y.push(data.peak_connection_count);
                    this.series[1].data[0].y.push(data.websocket_message_count);
                    this.series[2].data[0].y.push(data.api_message_count);

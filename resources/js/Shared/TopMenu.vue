...
<ul class="navbar-nav">
        ...
        <div class="dropdown-menu">
            <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                    <Link class="dropdown-item" href="/admin/excavation-field">
                        Kopovi
                    </Link>
                    <Link class="dropdown-item" href="/admin/rodent">
                        Bageri
                    </Link>
                    <Link class="dropdown-item" href="/admin/rodent-type">
                        Modeli Bagera
                    </Link>
    ...
    <li class="nav-item">
        <Link href="/admin/websockets" class="nav-link">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
    ...
    <li class="nav-item">
        <Link href="/admin/user" class="nav-link">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
    ...
    <li class="nav-item">
        <Link href="/admin/phpinfo" class="nav-link">
            <span class="nav-link-icon d-md-none d-lg-inline-block">

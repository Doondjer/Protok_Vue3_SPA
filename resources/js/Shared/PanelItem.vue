<template>
    <div class="col-sm-12 col-md-6 col-lg-4">
        <div class="card" :title="resource.data.name">
            ...
            <div class="pt-2">
                <div class="d-flex px-3">
                    ...
                    <h3 class="ms-2 mt-2 text-nowrap" v-text="resource.data.name"></h3>
                    <div class="ms-2 mt-1">
                        <a href="#" class="text-info bg-green-lt" @click.prevent="$emit('show_details', {station: resource.data.id})" aria-label="Prikaži Detalje">
                    ...
                    <div class="ms-auto mt-2">
                        <a class="btn w-100" @click.prevent="$emit('show_graph', {station: resource.data.id})" href="#">
                 ...
                 <chart :resource_id="resource.data.id" />
                    ...
                    <div class="h1 mb-0 ms-3 col" v-text="`${current_flow} m3/h`"></div>
                        ...
                        <div class="me-auto" v-if=" ! loading && isComunication">
                            <a href="#" @click.prevent="toggleStatuses" class="d-inline-flex align-items-center lh-1" :class="isComunication ? 'text-success' : 'text-danger'">
                               <svg v-if="$page.props.auth.user && $page.props.auth.user.is.admin" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
<script setup>
    ...
    import chart from './PanelItemChart';
    ...
    let toggleStatuses = () => {
        show_status.value = ! show_status.value;
    };

    let isComunication = computed(() => {
        return props.statuses.reduce((a, b) => a || b, false);
    });
/*
